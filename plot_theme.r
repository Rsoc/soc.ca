    ...
    axisColor='black', gridColor='grey70', textColor='black') 
{
    opts(
        ...
        axis.text.y = theme_text(hjust=1, vjust=0.5, colour=axisColor, family=font, face=face, size=8),
	#axis.text.x = theme_text(vjust=1, hjust=0.5, colour=axisColor, family=font, face=face, size=size),
        ...
        axis.title.x = theme_text(family=font, face=face, colour=axisColor, size=size),
