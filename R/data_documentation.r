...
#' sciences. The soc.ca package produces specific and class specific multiple correspondence 
#' analysis on survey-like data. Soc.ca is optimized to only give the most 
#' essential statistical output sorted so as to help in analysis. 
#' Seperate functions exists for near publication-ready plots and tables.
#' 
#' We are in debt to the work of others, especially Brigitte Le Roux and 
#' Henry Rouanet for the mathematical definitions of the method and their 
#' examples. Furthermore this package was initially based on code from the ca 
#' package written by Michael Greenacre and Oleg Nenadic.
#' 
#' If you are looking for features that are absent in soc.ca, it may be 
#' available in some of these packages for correspondence analysis: 
